...
public class SubPlusTextView extends LinearLayout {
	...
	private void initViews() {
		...
		LinearLayout goods_count_plus_ll = (LinearLayout) sub_plus
				.findViewById(R.id.ll_dialog_count_plus);
		LinearLayout goods_count_sub_ll = (LinearLayout) sub_plus
				.findViewById(R.id.ll_dialog_count_sub);
		sp_count = (TextView) sub_plus.findViewById(R.id.tv_dialog_goods_count);
		sp_count.setText(goodCount + "");

		goods_count_plus_ll.setOnClickListener(new OnClickListener() {
		...
		goods_count_sub_ll.setOnClickListener(new OnClickListener() {
